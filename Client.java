...
public class Client {
	...
	public static String path = "E:\\Masters\\Sem 2\\Advanced System Programming\\Project\\Prac 2\\client\\";

	public static void main(String[] args) throws Exception {
		Socket sock = new Socket("127.0.0.1", 11111);
				...
				if (receiveMessage.startsWith("get")) {
					...
					if (paramemeters.length > 2) {
						try (PrintWriter out = new PrintWriter(path + paramemeters[1])) {
							...
							System.out.println("Contetn to be write=" + txt);
